...
ActiveRecord::Schema[7.0].define(version: 20_250_526_101_048) do
  ...
  create_table 'active_storage_attachments', force: :cascade do |t|
    ...
    t.index %w[record_type record_id name blob_id], name: 'active_storage_attachments_uniqueness', unique: true
  end
